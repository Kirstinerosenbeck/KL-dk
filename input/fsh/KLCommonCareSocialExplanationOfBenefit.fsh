...
* status ^short = "[DK] sagsafgørelsesStatus"
* type ^short = "[DK] sagsafgørelseSektorkode"
* use ^short = "[DK] sagsafgørelsesBrug"
* patient ^short = "[DK] sagsafgørelseDrejerSigOm"
* created ^short = "[DK] sagsafgørelsesRegistreringstid"
* disposition ^short = "[DK] sagsafgørelseBegrundelse"
* insurer ^short = "[DK] sagsafgørelseTildelendeOrganisation"
* provider ^short = "[DK] sagsafgørelseLeveringsansvarligOrganisation"
* insurance ^short = "[DK] sagsafgørelsesUdgiftsdækning"
* outcome ^short = "[DK] sagsafgørelseStatusForIndeholdteYdelsesafgørelser"
* extension[municipalityCaseNumber] ^short = "[DK] sagsafgørelseIndgårISag"
